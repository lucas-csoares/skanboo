...
public class UsuarioController {
    ...
    public ResponseEntity<Void> criarUsuario (@Valid @RequestBody Usuario obj) {
        ...
        this.usuarioService.criarUsuario(obj);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> atualizarUsuario(@Valid @RequestBody Usuario obj, @PathVariable Long id) {
        
        obj.setId(id);
        obj = this.usuarioService.atualizarUsuario(obj);
